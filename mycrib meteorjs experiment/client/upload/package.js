...
Package.onUse(function(api){
    ...
    api.addFiles(['client.upload.library.js'], ['client']);
    api.addFiles(['server.upload.library.js'], ['server']);
    if(api.export)
    {
        api.export('deUploadPhoto'); //server
        api.export('deUploadFile'); //
    }
});